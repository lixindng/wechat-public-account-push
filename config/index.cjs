...
const USER_CONFIG = {
  ...
  APP_SECRET: '65a34b0b61feae05a537ed2e2414963f',
  ...
  USERS: [
    {
      ...
      useTemplateId: '1txDcNOVKuRWT6ZDDVIY6oziJkBInqo0Eib0UDwEMUQ',
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2022-10-15' },
      ],
    },
  ],
  ...
  CALLBACK_TEMPLATE_ID: '1txDcNOVKuRWT6ZDDVIY6oziJkBInqo0Eib0UDwEMUQ',
